---
title: "Epidemiologic surveillance"
...
- Important measures:
  ...
  - **Specificity:** Probability of an alarm when no disease emerges ($\rightarrow$ emergences are rare events: positive predictive values can be low)
